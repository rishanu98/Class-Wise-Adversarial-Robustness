...
import random
from utils.attacks import pgd_linf,pgd_linf_targ2,mixup_data
...
def eval_test(model,device, test_loader):
    ...
    plt.ylabel('True')
    plt.title('Confusion Matrix for targeted Attacks and untargeted testing')


    plt.tight_layout()

    plt.savefig('./RESULTS/Conf_Mat_BAT_UNTARGETD_TESTING+TARGETED_TRAINING.png')
