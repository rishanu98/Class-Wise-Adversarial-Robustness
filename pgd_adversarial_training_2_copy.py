...
def test(epoch):
   ...
   # test_metrics['Clean Test Accuracy'] = test_metrics['Clean Test Accuracy'].round(3)
   # test_metrics['Untargeted Test Accuracy'] = test_metrics['Untargeted Test Accuracy'].round(3)
