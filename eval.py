...
def eval_test_new(model, device, test_loader, class_names):
    ...
    plot_confusion_matrix(clean_conf_matrix, class_names, title='Confusion Matrix for CFA untargeted training and clean testing')
    ...
    plot_confusion_matrix(targeted_conf_matrix, class_names, title='Confusion Matrix for CFA untargeted training and targeted testing')
    ...
    plot_confusion_matrix(untargeted_conf_matrix, class_names, title='Confusion Matrix for CFA untargeted training and Untargeted testing')
...
if __name__ == '__main__':
    ...
    file_name = 'AT_CCM'   # Change file name to load respective weights of the model
